 ...
 *
 * @param modeID a string indicating a valid playback mode as retrieved by ts3client_getPlaybackModeList or ts3client_getDefaultPlaybackMode
 * @param result address of a variable that receives a NULL terminated array like `{{char* deviceName, char* deviceId}, ..., NULL}`.
 * Memory is allocated by the client lib and caller must free individual strings, array members and the array itself using @ref ts3client_freeMemory
 * @return An Error code from the @ref Ts3ErrorType enum indicating either success or the failure reason
*/
 ...
 *
 * @param modeID a string indicating a valid capture mode as retrieved by ts3client_getCaptureModeList or ts3client_getDefaultCaptureMode
 * @param result address of a variable that receives a NULL terminated array like `{{char* deviceName, char* deviceId}, ..., NULL}`.
